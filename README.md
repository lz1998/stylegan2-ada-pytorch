...
* Python libraries: `pip install click requests tqdm pyspng ninja imageio-ffmpeg==0.4.3 scipy pillow torch`.  We use the Anaconda3 2020.11 distribution which installs most of these by default.
